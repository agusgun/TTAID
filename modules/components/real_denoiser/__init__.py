...
def build_components(args):
    ...
    restoration_net = RestorationNet(args.input_channels, args.output_channels, args.restoration_base_features, args.restoration_scale_features, kernel_size=3, bias=False)
