...
class Trainer(object):
    ...
    def __init__(self, model, train_loader, val_loader, args):
        ...
        self.logger.info('Number of model parameters: {}'.format(self.model.count_parameters()))
        ...
        for epoch in range(self.start_epoch, self.end_epoch):
            ...
            if ((epoch + 1) % self.args.validate_every) == 0:
                ...
                if performance > self.best_performance:
                    ...
                    self.logger.info(
                        "best performance achieved at epoch {} with performance of {}".format(epoch, self.best_performance))
